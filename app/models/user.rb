class User < ApplicationRecord
  ...
  has_many :trips, foreign_key: :transporter_id, inverse_of: :transporter, dependent: :destroy
  has_many :packages, foreign_key: :dispatcher_id, inverse_of: :dispatcher, dependent: :destroy
