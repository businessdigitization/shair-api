ApplicationRecord.transaction do
  ...
  item_category = ParcelItemCategory.create!(name: 'Electronic')
  ParcelItemCategory.create!(name: 'Cosmetics')
  parcel_item = ParcelItem.create!(name: 'Golla', count: 1, parcel: parcel, category: item_category)
